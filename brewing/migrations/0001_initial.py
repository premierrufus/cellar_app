    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('yeast_type', models.CharField(choices=[('001', '001'), ('3470', '3470'), ('other', 'Other')], default='001', max_length=100, verbose_name='Yeast Type')),
                ('yeast_gen', models.CharField(blank=True, max_length=100, null=True, verbose_name='Yeast Generation')),
                ('yeast_origin_gyle', models.CharField(blank=True, max_length=100, null=True, verbose_name='Yeast Origin Gyle')),
                ('yeast_log', models.TextField(blank=True, help_text='Enter yeast notes here.', null=True, verbose_name='Yeast Log')),
                ('brix_log', models.TextField(blank=True, help_text='Enter Brix readings/notes here.', null=True, verbose_name='Brix Log')),
                ('transfer_log', models.TextField(blank=True, help_text='Enter transfer notes here.', null=True, verbose_name='Transfer Log')),
                ('gravity_log', models.TextField(blank=True, help_text='Enter gravity readings here.', null=True, verbose_name='Gravity Log')),
                ('cellaring_log', models.TextField(blank=True, help_text='Enter any cellaring notes here.', null=True, verbose_name='Cellaring Log')),
                ('notes', models.TextField(blank=True, help_text='Enter batch notes here.', null=True, verbose_name='Batch Notes')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('container_type', models.CharField(choices=[('F', 'Fermentation'), ('B', 'Brite'), ('A', 'Aging')], default='F', max_length=100, verbose_name='Container Type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cdt', models.DateTimeField(auto_now_add=True, verbose_name='created')),
                ('mdt', models.DateTimeField(auto_now=True, verbose_name='modified')),
                ('entry_type', models.CharField(choices=[('B', 'Brix'), ('G', 'Gravity'), ('T', 'Transfer')], default='B', max_length=100, verbose_name='Entry Type')),
            ],
        ),
        migrations.CreateModel(
            name='Fermentable',
            fields=[
                ...
                ('amount', models.DecimalField(decimal_places=2, help_text='Weight of the fermentable, extract or sugar in pounds.', max_digits=14, verbose_name='amount')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cdt', models.DateTimeField(auto_now_add=True, verbose_name='created')),
                ('mdt', models.DateTimeField(auto_now=True, verbose_name='modified')),
                ('amount', models.DecimalField(decimal_places=2, help_text='Weight in pounds of the hops used in the recipe.', max_digits=14, verbose_name='amount')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ibu', models.DecimalField(blank=True, decimal_places=2, help_text='Target IBU', max_digits=4, null=True, verbose_name='IBU')),
                ('abv', models.DecimalField(blank=True, decimal_places=2, help_text='Target ABV (%)', max_digits=4, null=True, verbose_name='ABV')),
                ('srm', models.DecimalField(blank=True, decimal_places=2, help_text='Target SRM', max_digits=4, null=True, verbose_name='SRM')),
                ('notes', models.TextField(blank=True, null=True, verbose_name='notes')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cdt', models.DateTimeField(auto_now_add=True, verbose_name='created')),
                ('mdt', models.DateTimeField(auto_now=True, verbose_name='modified')),
                ('amount', models.DecimalField(decimal_places=2, help_text='Weight in ounces of the salt used in the recipe.', max_digits=14, verbose_name='amount')),
                ('notes', models.TextField(blank=True, null=True, verbose_name='notes')),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            name='Brix',
            fields=[
                ('entry_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='brewing.Entry')),
                ('value', models.DecimalField(decimal_places=2, help_text='Sugar content of an aqueous solution.', max_digits=14, verbose_name='Degrees Brix')),
                ('volume', models.DecimalField(decimal_places=2, help_text='Batch volume at the time of this reading.', max_digits=14, verbose_name='Batch Volume (Hl)')),
            ],
            bases=('brewing.entry',),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('entry_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='brewing.Entry')),
                ('value', models.DecimalField(decimal_places=2, help_text='Specific Gravity/Relative Density.', max_digits=14, verbose_name='Specific Gravity')),
            ],
            bases=('brewing.entry',),
        ),
        migrations.CreateModel(
